    ...
    <div className=\"space-y-12\">
      ...
      >
        <div className=\"text-center space-y-4\">
          <h2 className=\"text-3xl font-bold\">Weekly Podcast Topics</h2>
          <p className=\"text-gray-600 max-w-2xl mx-auto\">
            Each week, The DowUrk Mobile Podcast explores one of the Seven F's in depth, 
            featuring expert guests, success stories, and actionable advice.
          </p>
        </div>
        ...
        <div className=\"grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4 mt-8\">
          {frameworks.map((f, i) => (
            <div key={i} className=\"text-center\">
              <div className=\"w-16 h-16 mx-auto mb-2 rounded-full bg-gradient-to-br ${f.color} flex items-center justify-center text-white font-bold text-xl\">
                {i + 1}F
              </div>
