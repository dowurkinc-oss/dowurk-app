...
function Certifications() {
  const certifications = [
    { 
      ...
      abbr: 'MBE', 
      description: 'Certification for businesses owned by racial/ethnic minorities (51%+ ownership)' 
    },
    { 
      name: 'Women Business Enterprise', 
      abbr: 'WBE', 
      description: 'Certification for women-owned businesses (51%+ ownership)' 
    },
    { 
    ...
    { 
      ...
      abbr: 'SBE', 
      description: 'Certification for small businesses meeting size standards' 
    },
    { 
      name: '8(a) Business Development Program', 
      abbr: '8(a)', 
      description: 'SBA program for socially and economically disadvantaged entrepreneurs' 
    },
    { 
      name: 'HUBZone Certified', 
      abbr: 'HUBZone', 
      description: 'Federal certification for businesses in Historically Underutilized Business Zones' 
    },
    { 
      name: 'Veteran-Owned Small Business', 
      abbr: 'VOSB', 
      description: 'Certification for businesses owned by veterans (51%+ ownership)' 
    },
    { 
      name: 'Service-Disabled Veteran-Owned', 
      abbr: 'SDVOSB', 
      description: 'Certification for businesses owned by service-disabled veterans' 
    },
    { 
      name: 'LGBT Business Enterprise', 
      abbr: 'LGBTBE', 
      description: 'Certification for LGBT-owned businesses through NGLCC' 
    },
    { 
      name: 'Disability-Owned Business Enterprise', 
      abbr: 'DOBE', 
      description: 'Certification for businesses owned by individuals with disabilities' 
    },
    { 
    ...
    { 
      name: 'Louisiana Hudson Initiative', 
      abbr: 'Hudson', 
      description: 'Louisiana state certification for small entrepreneurship businesses' 
    }
  ];
